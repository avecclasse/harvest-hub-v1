        ...
        {activeSection === "sourcing" && (
          <div className="space-y-4">
            ...
            <ul className="list-inside list-disc space-y-2 text-harvest-earth">
              ...
              <li><strong>Pilot Phase:</strong> Harvest Hub is testing one coordinated produce drop—produce mix, pricing, and supply partners. Selected participants will receive fulfillment details & early feedback will inform what comes next.</li>
            </ul>
            <p className="text-harvest-earth">
              Selected participants will receive local pickup or delivery
              details. Specific locations and timing are shared after selection.
            </p>
          </div>
        )}
